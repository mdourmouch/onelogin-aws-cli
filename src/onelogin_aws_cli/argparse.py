...
class OneLoginAWSArgumentParser(argparse.ArgumentParser):
    ...
    def __init__(self):
        ...
        self.add_argument("-u", "--username", action=EnvDefault, required=False, help="Specify OneLogin username")
        ...
        self.add_argument(
            ...
            dest="reset_password",
            action="store_true",
            help="Prompt the user for password even if the password is stored in the OS keychain.",
            default=False,
        )

        self.add_argument("-v", "--version", action="version", version="%(prog)s " + version(__package__))
